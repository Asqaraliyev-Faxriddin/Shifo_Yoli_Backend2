export declare enum PaymeMethods {
...
export declare enum PaymeErrorCode {
...
export declare enum PaymeTransactionState {
    CREATED = 1,
    COMPLETED = 2,
    CANCELLED = -1,
    CANCELLED_AFTER_PAYMENT = -2
}
export declare enum PaymeTransactionReason {
...
export interface PaymeRequest<T = PaymeRequestParams[PaymeMethods.CheckPerformTransaction | PaymeMethods.CheckTransaction | PaymeMethods.GetStatement | PaymeMethods.CancelTransaction | PaymeMethods.CreateTransaction | PaymeMethods.PerformTransaction]> {
    method: PaymeMethods;
    params: T;
    id?: number;
}
...
export interface PaymeResponses {
    ...
    [PaymeMethods.CancelTransaction]: {
        transaction: string;
        cancel_time: number;
        state: PaymeTransactionState | PaymeTransactionState.CANCELLED_AFTER_PAYMENT;
    };
    [PaymeMethods.CheckTransaction]: {
        create_time: number;
        perform_time: number;
